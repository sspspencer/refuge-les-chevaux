      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-10 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-4 -z-10 w-full overflow-hidden bg-gray-100 ring-1 ring-gray-900/10 lg:w-1/2"></div>
          ...
          <div className=" flex  gap-6  sm:justify-start ">
            ...
            <div className="w-44 flex-none space-y-8 pt-32 sm:pt-72 lg:pt-56">
              <div className="relative">
                <img
                  alt=""
                  src="/volunteer3.jpg"
